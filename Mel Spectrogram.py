...
# +
src, sr = librosa.load('../UrbanSound8K/clean/3/14358-3-0-7_0.wav', sr=None, mono=True)
...
# +
hop_length = 1024
src, sr = librosa.load('../UrbanSound8K/wavfiles/3/14358-3-0-7.wav', sr=None, mono=True)
print('Audio length: %d samples, %04.2f seconds. \n' % (len(src), len(src) / sr) +
      'Audio sample rate: %d Hz' % sr)
dt = 1.0
